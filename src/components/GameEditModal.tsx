  ...
  return (
    <Modal open={open} onClose={onClose} title="게임 수정" wide>
      <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
        ...
        {/* 칩 보정 */}
        <div>
          <span className="text-[13px] font-bold block mb-2">칩 보정 <span className="text-mut font-normal">· 카운팅 오류 정정</span></span>
        ...
        {/* 애드온 */}
        <div>
          <span className="text-[13px] font-bold block mb-2">애드온</span>
          ...
          <p className="text-[12px] text-mut mt-1.5">즉시 반영됩니다. 전광판 TOTAL STACKS에 합산됩니다.</p>
        </div>
