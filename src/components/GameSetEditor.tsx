      ...
      <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <span className="text-[16px] font-bold">게임 스트럭쳐</span>
          ...
          <div className="overflow-x-auto border border-line rounded-xl">
            <table className="w-full text-[16px]">
              <thead>
                <tr className="text-left text-[14px] text-mut border-b border-line">
        ...
        {/* 참가 조건 */}
        <div>
          <span className="text-[16px] font-bold block mb-2">참가 조건 (재화별 비용 → 지급 칩)</span>
          <div className="overflow-x-auto border border-line rounded-xl">
            <table className="w-full text-[16px]">
              <thead>
                <tr className="text-left text-[14px] text-mut border-b border-line">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          <div>
            <span className="text-[16px] font-bold block mb-2">얼리버드 (참가 레벨별 보너스 칩)</span>
          ...
          <div>
            <span className="text-[16px] font-bold block mb-2">프라이즈 (순위별 포인트)</span>
            <div className="space-y-2">
              {gs.prizes.map((p, i) => (
                <div key={i} className="flex items-center gap-2">
